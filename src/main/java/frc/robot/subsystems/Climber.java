...
public CANSparkMax rightClimber = new CANSparkMax(kCLIMBER_LEFT_A_NODE_ID, MotorType.kBrushed);//CANSparkMaxLowLevel.MotorType.kBrushless);
...
double Height = ((RelativeEncoder) rightClimber).getPosition();
