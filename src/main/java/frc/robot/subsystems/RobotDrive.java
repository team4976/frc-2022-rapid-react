...
public class RobotDrive extends SubsystemBase { 
    ...
    private int kDRIVE_NODE_ID;
    public final TalonSRX left = new TalonSRX(kDRIVE_NODE_ID);  
    public final TalonSRX right = new TalonSRX(kDRIVE_NODE_ID);  

public RobotDrive(){
    new VictorSPX(kDRIVE_LEFT_B_NODE_ID).follow(left); 
    new VictorSPX(kDRIVE_LEFT_B_NODE_ID).follow(right);
  }
