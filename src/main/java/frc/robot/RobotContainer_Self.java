...
import frc.robot.commands.IntakeBall_Self;
 ...
 */
public class RobotContainer_Self {

  // The robot's subsystems and commands are defined here...
  private final RobotDrive _robotDrive = new RobotDrive();
  private final Intake_Self _intake = new Intake_Self();
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(_primaryController, XboxController.Button.kB.value)
      .whenPressed(new IntakeBall_Self(_intake));

    new JoystickButton(_primaryController, XboxController.Button.kX.value)
      .whenPressed(new frc.robot.commands.RemoveBall(_intake));
  }
